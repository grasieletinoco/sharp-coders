...
namespace IntroPOO; // Espaço Declarativo
...
public class Program
{
   public static void ImprimeMusica(Song musica) {
      ...
      // Não Consegue Exibir pois é Privado (RUIM)
   ...
   public static void Main(string[] args)
   {
      ...
      // construtor = Melhorar a Criação de Objetos
      ...
      // Utilização dos Nossos Atributos

      // Não Consegue Editar a Variável Privada (BOM)
