...
public class Conta
{
  ...
  public virtual void Depositar(double quantia) {
    ...
    Saldo += quantia; // Aumentou o saldo
    Transacoes.Add(new Transacao(quantia, TipoTransacao.DEPOSITO, DirecaoTransacao.ENTRADA)); // Registrou
  }
  ...
  // Transferência é um saque na conta e um depósito em outra
